  ...
  return (
    <div className={styles.container}>
      <div className={styles.row}>
        ...
        <div className={styles.bentoMenuContainer} onClick={onBentoClick}>
          <CgMenuGridO className={styles.bentoMenu}/>
        </div>

        <div className={styles.logoContainer} onClick={onProfileClick}>
      ...
      <div className={`${styles.dropdown} ` +
        ...
        <div className={styles.dropdownItems}>
          {homeDropdownContent.map((item) => {
            return (
              <a href={item.link} className={styles.dropdownItem}>
      ...
      <div className={styles.profileDropdown} style={{
        visibility: isProfileClicked ? 'visible' : 'hidden',
      }}>
        <img src={logo} alt="" className={styles.dropdownProfile}/>
        <p className={styles.dropdownName}>Christian Gazzingan</p>
        <p className={styles.dropdownEmail}>christiangazzingan38@gmail.com</p>
        <a href="#" className={styles.contentLink}>View My Another Website</a>

        <a href="#" className={styles.sectionTwoContainer}>
        ...
        <div className={styles.sectionThreeContainer}>
          <a href="#" className={styles.sectionThreeButtonLink}>Github</a>
        </div>
